...
<html lang="fr">
  ...
  <head>
    ...
    <meta name="description" content="Page de présentation du projet PacMan de Ewen Beaufils.">
    <title>PacMan - Ewen - Portfolio Gwendal et Ewen</title>
  ...
  <body class="color perso-1">
    ...
    <div class="section">
      <div class="container">
        <h1 class="center animate__animated animate__rubberBand">Projet Pac Man</h1>
        <img class="responsive-img center-box border-radius animate__animated animate__bounceIn" src="../img/pacman-02.jpg" alt="Image du site Pac Man">
        <div class="row color perso-2 border-radius project-skill">
          <p class="col s12 center">Ce projet était un travail en solo, où l'objectif était de créer un jeu vidéo en 2D en LUA à partir de l'interpréteur TIC-80, en moins de 2 jours.</p>
          <div class="col s12 m4 offset-m1 center color perso-1 border-radius">
            ...
            <ul>
              <li class="animate__animated animate__bounceInLeft"><i class="fa-solid fa-terminal"></i> LUA</li>
              <li class="animate__animated animate__bounceInLeft"><i class="fa-solid fa-robot"></i> TIC-80</li>
            </ul>
          </div>
