...
<html lang="fr">
  ...
  <head>
    ...
    <meta name="description" content="Page de présentation du projet Rocket-League de Ewen Beaufils.">
    <title>RocketLeague - Ewen - Portfolio Gwendal et Ewen</title>
  ...
  <body class="color perso-1">
    ...
    <div class="easter-gif border-radius">
      <img src="../img/hastley-rick.gif" class="responsive-img" alt="you rick rolled">
    </div>
